...
## Setting metadata
LABEL "com.github.actions.repository"="https://github.com/AlexRogalskiy/github-action-random-quote"
LABEL "com.github.actions.homepage"="https://github.com/AlexRogalskiy/github-action-random-quote"
